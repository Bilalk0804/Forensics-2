  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Forensics design system
        rust: "hsl(var(--rust))",
        "rust-dim": "hsl(var(--rust-dim))",
        sand: "hsl(var(--sand))",
        "sand-dim": "hsl(var(--sand-dim))",
        "slate-deep": "hsl(var(--slate-deep))",
        "slate-panel": "hsl(var(--slate-panel))",
        "slate-raised": "hsl(var(--slate-raised))",
        ...
        "threat-clean": "hsl(var(--threat-clean))",
